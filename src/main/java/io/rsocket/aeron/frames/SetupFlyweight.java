...
public final class SetupFlyweight {
  private SetupFlyweight() {}
  
  public static ByteBuf encode(
      ByteBufAllocator allocator, long connectionId, int streamId, String aeronUrl) {
    
    ByteBuf byteBuf = AeronPayloadFlyweight.encode(allocator, FrameType.SETUP);
